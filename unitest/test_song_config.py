...
class TestSuite(unittest.TestCase):
    ...
    def test_init(self):
        ...
        for piano_midi, strings_midi, drums_midi, bass_midi in zip(
            piano_mids, strings_mids, drums_mids, bass_mids
        ):
            config = {
                "Name": "Test",
                "Artist": "",
                "OutputPath": "./WAVs/test_max_plus_one/",
                "Tracks": [
                    {"track_name": "Drums", "midi_path": drums_midi},
